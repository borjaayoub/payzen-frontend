...
export class HolidaysComponent {
    ...
    this.holidayService.getHolidays(filters).subscribe({
      ...
      error: (error) => {
        ...
        this.messageService.add({
          severity: 'error',
          summary: 'Error',
          detail: 'holidays.errors.loadFailed'
        });
        this.isLoading.set(false);
      }
    });
    ...
    this.holidayService.createHoliday(request).subscribe({
      next: () => {
        this.messageService.add({
          severity: 'success',
          summary: 'Success',
          detail: 'holidays.messages.createSuccess'
        });
        this.closeDialog();
        this.loadHolidays();
      },
      error: (error) => {
        ...
        this.messageService.add({
          severity: 'error',
          summary: 'Error',
          detail: 'holidays.errors.createFailed'
        });
      }
    });
  }
    ...
    this.holidayService.updateHoliday(holiday.id, request).subscribe({
      next: () => {
        this.messageService.add({
          severity: 'success',
          summary: 'Success',
          detail: 'holidays.messages.updateSuccess'
        });
        this.closeDialog();
        this.loadHolidays();
      },
      error: (error) => {
        ...
        this.messageService.add({
          severity: 'error',
          summary: 'Error',
          detail: 'holidays.errors.updateFailed'
        });
      }
    });
  }
  ...
  deleteHoliday(holiday: Holiday): void {
    this.confirmationService.confirm({
      message: 'holidays.confirmDelete',
      accept: () => {
        this.holidayService.deleteHoliday(holiday.id).subscribe({
          next: () => {
            this.messageService.add({
              severity: 'success',
              summary: 'Success',
              detail: 'holidays.messages.deleteSuccess'
            });
            this.loadHolidays();
          },
          error: (error) => {
            ...
            this.messageService.add({
              severity: 'error',
              summary: 'Error',
              detail: 'holidays.errors.deleteFailed'
            });
          }
        });
      }
